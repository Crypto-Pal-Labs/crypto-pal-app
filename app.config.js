...
module.exports = ({ config }) => {
  return {
    ...
    extra: {
      ...
      ETH_RPC_URL: process.env.EXPO_PUBLIC_ETH_RPC_URL || process.env.ETH_RPC_URL,
      BSC_RPC_URL: process.env.EXPO_PUBLIC_BSC_RPC_URL || process.env.BSC_RPC_URL,
      ...
      POLYGON_RPC_URL: process.env.EXPO_PUBLIC_POLYGON_RPC_URL || process.env.POLYGON_RPC_URL
    }
  };
};